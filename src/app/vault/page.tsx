    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
        <div>
          ...
          <div style={{ fontSize: 10, color: '#a1a1aa', letterSpacing: '0.06em', marginBottom: 8 }}>
            {short}
          </div>
          <a
    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .lbl{font-size:10px;color:#8b949e;letter-spacing:0.1em;text-transform:uppercase}
      `}</style>
          ...
          <aside style={{ width: 220, borderRight: '1px solid #111827', display: 'flex', flexDirection: 'column', flexShrink: 0, background: '#070B14' }}>
            ...
            <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '18px 20px', borderBottom: '1px solid #111827', textDecoration: 'none' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 8, color: '#8b949e', letterSpacing: '0.1em' }}>sBTC YIELD VAULT</div>
              </div>
            </Link>

            <div style={{ padding: '14px 20px 8px', fontSize: 9, color: '#8b949e', letterSpacing: '0.18em' }}>STEPS TO EARN</div>
              ...
              {STEPS.map(step => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <div style={{ fontSize: 11, color: isActive ? '#e8edf5' : reachable ? '#cbd5e0' : '#8b949e', letterSpacing: '0.04em', marginBottom: 2 }}>{step.label}</div>
            ...
            <div style={{ borderTop: '1px solid #111827', padding: 16 }}>
              {isConnected ? (
                <div>
                  ...
                  <button
                    onClick={loadData}
                    style={{ width: '100%', padding: '7px', border: '1px solid #1c2235', background: 'transparent', color: '#a1a1aa', fontSize: 8, letterSpacing: '0.12em', cursor: 'pointer', fontFamily: '"DM Mono",monospace', marginBottom: 6, transition: 'color 0.2s' }}
                  ...
                  <button
                    ...
                    style={{ width: '100%', padding: '9px', border: '1px solid #1c2235', background: 'transparent', color: '#a1a1aa', fontSize: 9, letterSpacing: '0.12em', cursor: 'pointer', fontFamily: '"DM Mono",monospace', transition: 'all 0.2s' }}
              ...
              {[
                ...
                <div key={c.code} style={{ background: '#0a0f1e', padding: '24px 24px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                    <div style={{ fontSize: 9, color: '#8b949e', letterSpacing: '0.14em' }}>{c.label.toUpperCase()}</div>
                  ...
                  <div style={{ fontSize: 9, color: '#8b949e', letterSpacing: '0.1em' }}>{c.sub}</div>
                </div>
              ))}
            </div>
            ...
            <div style={{ flex: 1, padding: 28, paddingBottom: 48, animation: 'fadeUp 0.3s ease' }}>
              ...
              {activeStep === 1 && (
                <div style={{ maxWidth: 520, margin: '0 auto' }}>
                  ...
                  <p style={{ fontSize: 12, color: '#a1a1aa', lineHeight: 1.8, marginBottom: 28 }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1, background: '#111827', marginBottom: 28 }}>
                    {[
                      ...
                      <div key={w.name} style={{ background: '#0a0f1e', padding: 20 }}>
                        ...
                        <div style={{ fontSize: 13, color: '#f1f5f9', marginBottom: 6, letterSpacing: '0.04em' }}>{w.name}</div>
                ...
                <div style={{ maxWidth: 520, margin: '0 auto' }}>
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <div style={{ position: 'absolute', right: 0, top: 0, height: '100%', display: 'flex' }}>
                        ...
                        <button
                          ...
                          style={{ padding: '0 12px', background: '#0a0f1e', border: 'none', borderLeft: '1px solid #1c2235', color: '#a1a1aa', fontSize: 9, letterSpacing: '0.1em', cursor: 'pointer', fontFamily: '"DM Mono",monospace', transition: 'color 0.2s' }}
                  ...
                  {vaultInfo.depositedSbtc > 0 && (
                    <button
                      ...
                      disabled={isPending}
                      style={{ marginTop: 10, width: '100%', padding: '11px', border: '1px solid #1c2235', background: 'transparent', color: '#a1a1aa', fontSize: 10, letterSpacing: '0.1em', cursor: 'pointer', fontFamily: '"DM Mono",monospace', transition: 'all 0.2s' }}
              ...
              {activeStep === 3 && (
                <div style={{ maxWidth: 520, margin: '0 auto' }}>
                  ...
                  <p style={{ fontSize: 12, color: '#a1a1aa', lineHeight: 1.8, marginBottom: 24 }}>
                    Leather will pop up <strong style={{ color: '#f1f5f9' }}>twice</strong> — once to deposit your sBTC, then again to activate the 1.5× leverage loop. Both must be approved.
                  </p>
                  ...
                  <div style={{ background: '#0a0f1e', border: '1px solid #1c2235', padding: '20px', marginBottom: 20 }}>
                    <div style={{ fontSize: 9, color: '#8b949e', letterSpacing: '0.14em', marginBottom: 14 }}>TRANSACTION SUMMARY</div>
                    {[
              ...
              {activeStep === 4 && (
                <div style={{ maxWidth: 520, margin: '0 auto' }}>
                  ...
                  <div style={{ background: '#0a0f1e', border: '1px solid #111827', padding: '24px 20px', marginBottom: 20, textAlign: 'center' }}>
                    <div style={{ fontSize: 9, color: '#8b949e', letterSpacing: '0.14em', marginBottom: 10 }}>CLAIMABLE NOW</div>
                    <div style={{
                    ...
                    <div style={{ fontSize: 12, color: '#8b949e' }}>USDCx {loadingBal ? '' : accruedYieldUsd}</div>
                  </div>
                  ...
                  <button
                    onClick={loadData}
                    disabled={loadingBal}
                    style={{ marginTop: 10, width: '100%', padding: '11px', border: '1px solid #1c2235', background: 'transparent', color: '#a1a1aa', fontSize: 10, letterSpacing: '0.1em', cursor: 'pointer', fontFamily: '"DM Mono",monospace', transition: 'color 0.2s' }}
                    onMouseEnter={e => (e.currentTarget.style.color = '#c8d0e0')}
                    onMouseLeave={e => (e.currentTarget.style.color = '#5a6585')}
                  >
                  ...
                  <div style={{ marginTop: 16, padding: '14px 18px', background: '#0a0f1e', border: '1px solid #111827', fontSize: 10, color: '#a1a1aa', lineHeight: 1.7 }}>
                    <div style={{ fontSize: 9, color: '#8b949e', letterSpacing: '0.12em', marginBottom: 8 }}>VAULT POSITION DETAILS</div>
                    {[
                      ...
                      <div key={r.k} className="dr">
                        <span className="lbl">{r.k}</span>
                        <span style={{ fontSize: 12, color: '#f1f5f9' }}>{r.v}</span>
                      </div>
                    ))}
                  </div>
                </div>
